                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a href="<?php echo SITEURL; ?>/home1"><i class="fa fa-home"></i> Home </a></li>
                                <li><a href="<?php echo SITEURL; ?>/category"><i class="fa fa-calendar"></i> Category </a></li>
                                <li><a href="<?php echo SITEURL; ?>/sub_category"><i class="fa fa-book"></i>  Sub-category </a></li>
                                <li><a href="<?php echo SITEURL; ?>/school"><i class="fa fa-upload"></i> School </a></li>
                                
                                <li><a href="<?php echo SITEURL; ?>/course"><i class="fa fa-book"></i> Course </a></li>
                                <li><a href="<?php echo SITEURL; ?>/buyers"><i class="fa fa-dollar"></i> Incomes </a></li>
                                <li><a href="<?php echo SITEURL; ?>/activation"><i class="fa fa-dollar"></i> Activation </a></li>
                                <li><a href="<?php echo SITEURL; ?>/view/blog-list"><i class="fa fa-bullseye"></i> Blog List</a>
                                <li><a href="<?php echo SITEURL; ?>/view/blog-category"><i class="fa fa-list"></i> Blog Category</a>
